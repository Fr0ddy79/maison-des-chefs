...
- Name: mai-1196-booking-status-ui.spec.ts >> MAI-1196: Booking Status UI QA >> AC4: Booking status page shows event details
- Location: tests/mai-1196-booking-status-ui.spec.ts:143:3
