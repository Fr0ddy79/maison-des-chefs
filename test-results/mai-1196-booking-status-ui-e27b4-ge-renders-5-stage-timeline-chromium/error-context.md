...
- Name: mai-1196-booking-status-ui.spec.ts >> MAI-1196: Booking Status UI QA >> AC3: Booking status page renders 5-stage timeline
- Location: tests/mai-1196-booking-status-ui.spec.ts:113:3
